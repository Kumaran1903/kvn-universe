...
export async function POST(req) {
  try {
    ...
    const products = purchasedItems.map((item) => item.title);
    ...
    verifyFormData.append("products", JSON.stringify(products));
    ...
    fetch("https://kevin-payment-verifier.onrender.com/api/verify", {
      method: "POST",
      body: verifyFormData,
    });
